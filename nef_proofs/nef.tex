...
\newcommand{\rmrk}[1]{{#1}}    %{\textcolor{red}{#1}}
...
For a single ring we discuss how the sign of $I$ fluctuates as the intensity 
of the driving is increased, while for an ensemble of rings we highlight 
the fingerprints of Sinai physics on the distribution of the absolute value of $I$.   
\end{abstract}
...
\bibitem{kbb}
D. Hurowitz, D. Cohen,
% Non-equilibrium steady state of sparse systems with non-trivial topology. 
